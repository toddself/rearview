...
var baseViewOpts = {
  ...
  /**
   * Returns the HTML string representing the object. Cheerio VS jQuery leaks
   * badly here, so this could probably be handled better
   * @private
   * @memberOf BaseView
   * @method _getHTML
   * @return {string} The HTML for the entire element.
   */
  _getHTML: function () {
    if (process.browser) {
      return this.$el[0];
